...
namespace TanukiColiseum
{
    public class Options
    {
        ...
        public int Contempt1 { get; set; }
        public int Contempt2 { get; set; }
        ...
        public MainModel ToModel()
        {
            ...
            model.Contempt1.Value = Contempt1;
            model.Contempt2.Value = Contempt2;
            return model;
        }
