...
namespace TanukiColiseum
{
	...
	public class MainModel : INotifyPropertyChanged
	{
		...
		[DataMember]
		public ReactiveProperty<int> MinimumThinkingTime1 { get; set; } = new ReactiveProperty<int>(0);
		...
		public void Load(string filePath)
		{
			...
			if (model.MinimumThinkingTime1 == null)
			{
				model.MinimumThinkingTime1 = new ReactiveProperty<int>(0);
			}

			if (model.MinimumThinkingTime2 == null)
			{
